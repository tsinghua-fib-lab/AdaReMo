...
from urban_planning.models.reward import UrbanPlanningReward

def create_rgnn_model(cfg, agent):
    ...
    reward_net = UrbanPlanningReward(cfg.reward_specs, agent, shared_net)
    return policy_net, value_net, reward_net
