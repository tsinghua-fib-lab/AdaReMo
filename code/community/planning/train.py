...
flags.DEFINE_string('root_dir', '/data2/suhongyuan/DRL-urban-planning', 'Root directory for writing '
...
flags.DEFINE_integer('gpu_index', 1, 'GPU ID.')
...
def main_loop(_):
    ...
    setproctitle.setproctitle(f'DO_NOT_USE_CUDA_{FLAGS.gpu_index}')
